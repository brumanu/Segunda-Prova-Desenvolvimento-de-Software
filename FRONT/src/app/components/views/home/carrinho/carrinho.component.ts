...
export class CarrinhoComponent implements OnInit {
    ...
    constructor(private itemService: ItemService, private vendaService: VendaService, private router: Router, private formaPagamentoService: FormaPagamentoService
    ) {}
